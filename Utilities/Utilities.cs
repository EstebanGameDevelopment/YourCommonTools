...
namespace YourCommonTools
{
    ...
    public static class Utilities
    {
        ...
        */
		 ...
		 */
        public static void SetCenteredToParentSize(this RectTransform _mRect, RectTransform _parent)
        {
            _mRect.anchoredPosition = _parent.position;
            _mRect.anchorMin = new Vector2(0.5f, 0.5f);
            _mRect.anchorMax = new Vector2(0.5f, 0.5f);
